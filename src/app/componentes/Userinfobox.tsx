  ...
  return (
    <main className="">
      <div className="flex flex-col justify-center items-center gap-4 relative w-170 h-96 bg-gray-300 rounded-xl shadow-lg p-4">
        <img src={picture} alt="User" className="rounded-full w-25 h-25 mb-2" />
        ...
        <div className="flex gap-8 items-center">
          ...
          <button className="text-white" onClick={() => setData("name")}> 
          ...
          <button className="text-white" onClick={() => setData("email")}> 
            <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <button className="text-white" onClick={() => setData("birthday")}> 
            <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <button className="text-white" onClick={() => setData("address")}> 
            <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <button className="text-white" onClick={() => setData("phone")}> 
            <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <button className="text-white" onClick={() => setData("password")}> 
            <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
